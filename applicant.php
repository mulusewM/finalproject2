            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              ...
              ?>
                          ...
                          <ul class="nav side-menu">
                                ...
                                <li><a href="postedvacancy.php"><i class="fa fa-edit"></i>  postedvacancy <span class="fa fa-chevron-down"></span></a>
                                ...
                                <ul id="menu1" class="dropdown-menu list-unstyled msg_list animated fadeInDown" role="menu">
                                    ...
                                    <li>
                                        <div class="text-center">
                                               <i class="fa fa-question"> <strong>view Account Request</strong>
                                               <br/> Request Date:&nbsp; <?php echo $z['order_date']; ?> </span></i>
